...
@Component({
  selector: 'app-informe-consolidado-final',
  templateUrl: './informe-consolidado-final.component.html',
  styleUrls: ['./informe-consolidado-final.component.css']
})
export class InformeConsolidadoFinalComponent implements OnInit {
  ...
  constructor(private reportService: ReportService, private schoolSevice: SchoolService, private alertService: AlertService, private courseService: CourseService, private radicadorValoracionesFinalesService: RadicadorValoracionesFinalesService) {
    ...
    this.getGeneralPerformanceInformation();
  }

  async getGeneralPerformanceInformation() {
    const result = await this.reportService.getGeneralPerformanceInformation();
    this.performanceInformation = result;
  }
