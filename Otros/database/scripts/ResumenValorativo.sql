...
BEGIN
declare sqlQuery varchar(4000) default 'create temporary table temporalValorativeResumen ( idStudent integer, period int, generalAverage decimal(10,2) ';
...
set sqlQuery = concat(sqlQuery,', `',idMatter,'` decimal(10,2) null');
...
/*
##Crear una tabla temporal con la estructura

select al.idMatter, a.area ,m.matter
from AcademicLoads as al 
inner join Matters as m
 on m.id = al.idMatter 
inner join Areas as a
